...
# Now import from gmm_ts and MM-TSFlib
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='GMM-TS: Online Gating for Multi-Modal Time Series Forecasting')
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = setting + '_tsfn-experts' + args.model.replace(",","-") + '_tsft-experts' + args.llm_model
            if os.path.exists('./{}_online_gating_results/'.format("test") + setting + '/'):
