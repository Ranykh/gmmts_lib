def print_gating_args(args):
    print("\033[1m" + "Basic Config" + "\033[0m")
    print(f'  {"Task Name:":<20}{args.task_name:<20}{"Is Training:":<20}{args.is_training:<20}')
    print(f'  {"Expert config file:":<20}{args.all_experts_config:<20}')
    # Handle both online (model/llm_model) and offline (tsfn_experts/tsft_experts) naming
    tsfn = getattr(args, 'tsfn_experts', None) or getattr(args, 'model', 'N/A')
    tsft = getattr(args, 'tsft_experts', None) or getattr(args, 'llm_model', 'N/A')
    print(f'  {"tsfn experts:":<20}{tsfn:<20}{"tsft experts:":<20}{tsft:<20}')
    print(f'  {"Domain:":<20}{args.domain:<20}')
    ...
    print(f'  {"agg type:":<20}{args.agg_type:<20}{"d model:":<20}{args.gating_d_model:<20}')
    print(f'  {"n heads:":<20}{args.n_heads:<20}{"e layers:":<20}{args.e_layers:<20}')
    print(f'  {"enc in:":<20}{args.enc_in:<20}{"d FF:":<20}{args.d_ff:<20}')
